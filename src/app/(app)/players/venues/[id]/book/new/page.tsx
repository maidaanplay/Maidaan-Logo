...
export default function PlayerNewBookingPage() {
  ...
  const form = useForm<BookingFormValues>({
    ...
    defaultValues: {
      ...
      bookerContact: profile?.contact_number || "",
  ...
  // Pre-fill with profile data when profile loads
  useEffect(() => {
    if (profile) {
      if (profile.name) form.setValue("bookerName", profile.name);
      if (profile.contact_number && profile.contact_number !== form.getValues("bookerContact")) {
        form.setValue("bookerContact", profile.contact_number);
      }
    }
  }, [profile, form]);
  ...
  const onSubmit = async (data: BookingFormValues) => {
    ...
    try {
      ...
      router.push("/players/booking-success");
    } catch (error) {
